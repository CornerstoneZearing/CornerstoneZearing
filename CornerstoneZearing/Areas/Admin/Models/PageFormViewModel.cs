...
public class PageFormViewModel
{
    ...
    [Required, MaxLength(200), Display(Name = "Page Name")]
    ...
    [Required, MaxLength(200), Display(Name = "URL Slug")]
    [RegularExpression(@"^[a-z0-9]+(?:-[a-z0-9]+)*$",
        ErrorMessage = "Slug must be lowercase letters, numbers, and hyphens only.")]
    public string UrlSlug { get; set; } = string.Empty;

    [MaxLength(200), Display(Name = "Meta Title")]
    public string? MetaTitle { get; set; }

    [MaxLength(500), Display(Name = "Meta Description")]
